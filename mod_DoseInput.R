...
#' @title   mod_DoseInput_ui
#' @description  UI of Shiny module which handles dose input.
#' @rdname mod_DoseInput_ui
#' @param id shiny id
...
# Module Server
#' @title   mod_DoseInput_server
#' @description  Server of Shiny module which handles dose input.
#' @rdname mod_DoseInput_server
#' @param input internal
#' @param output internal
#' @param session internal
...
mod_DoseInput_server <- function(input, output, session, initial, 
